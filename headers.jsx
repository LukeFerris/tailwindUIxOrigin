...
export default function SimpleCenteredOnLightHeaderExample() {
  return (
...
export default function SimpleCenteredOnDarkHeaderExample() {
    return (
  ...
  export default function SimpleOnDarkWithBackgroundImageExample() {
    return (
      <div className="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32">
        {/* This image must be replaced with a connected image url shown in the spec */}
        <img
  ...
  // header with cards on dark example
  import { SupportIcon, NewspaperIcon, PhoneIcon } from '@heroicons/react/solid'
...
export default function HeaderWithInfoCardsOnDarkExample() {
  return (
    <div className="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32">
        {/* This image must be replaced with a connected image url shown in the spec */}
      <img
