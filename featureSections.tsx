...
// these icons should be updated to icons which are relevant to this feature section
import {
  ArrowRightIcon,
  ArrowUpIcon,
  FingerPrintIcon,
...
export default function Centered2x2GridFeatureSectionExample() {
  return (
...
// these icons should be updated to icons which are relevant to this feature section
import { ArrowRightIcon, ArrowUpIcon, LockClosedIcon } from '@heroicons/react/solid'
...
export default function ThreeColumnsWithSmallIconsOnDarkExample() {
  return (
...
export default function ThreeColumnsWithSmallIconsOnLightExample() {
  return (
    <div className="bg-white py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center">
...
// these icons should be updated to icons which are relevant to this feature section
import { BellIcon, HeartIcon, PencilIcon, TrashIcon } from '@heroicons/react/outline'
...
export default function Offset2x2GridFeatureSectionExample() {
  return (
    <div className="bg-white py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
...
export default function OffsetWithLongFeatureListExample() {
  return (
    <div className="bg-white py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-3">
