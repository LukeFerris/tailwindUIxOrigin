...
export default function SinglePriceWithDetailsExample() {
  return (
...
export default function ThreeTierPricingSectionExample() {
  return (
    <div className="bg-white py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
...
export default function ThreeTierPricingWithDividersExample() {
  return (
    <div className="bg-white py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
